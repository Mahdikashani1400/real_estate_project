...
export default function Featurs() {
    return (
        ...
        <div className={styles["featurs"]}>
            <div className={styles["featur"]}>
                <svg className={styles["featur__icon"]}>
                    <use href="img/sprite.svg#icon-global"></use>
                </svg>
                <h4 className={"u-heading--dark"}>
                    بهترین خانه های لوکس جهان</h4>
